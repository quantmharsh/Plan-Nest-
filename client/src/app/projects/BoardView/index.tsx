...
//Designing the diffrent boards here 
...

{
  ...
  <div className="grid grid-cols-1 gap-4 p-4 md:grid-cols-2  lg:grid-cols-4  xl:grid-cols-4">
...
const TaskColumn = ({
  ...
  //counting number  of tasks in each status
...
const Task = ({ task }: TaskProps) => {
  ...
  return (
    <div ref={(instance)=>{ drag(instance);}}  className={`mb-4 rounded-md bg-white shadow dark:bg-dark-secondary ${
      isDragging ? "opacity-50" : "opacity-100"
    }`}> 
    {/* if we have attachment in that task  */}
