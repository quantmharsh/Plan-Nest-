...
const Home = (props: Props) => {
    //getting all the tasks  for given project 
    const { data: tasks,
    ...
    if (taskError || !projects || !tasks) {
        return (
            <div>
                Error occcured while fetching Data
            </div>
        )
    }
    ...
    const taskDistributions = Object.keys(priorityCount).map((key) => ({
        name: key,
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="rounded-lg bg-white p-4 shadow dark:bg-dark-secondary">
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={taskDistributions}>
                            <CartesianGrid
                                strokeDasharray="3 3"
